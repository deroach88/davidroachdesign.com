...
function twentyfourteen_setup() {
	...
	add_editor_style( array( 'css/editor-style.css', twentyfourteen_font_url(), 'fonts/genericons/genericons.css' ) );
...
if ( ! class_exists( 'Featured_Content' ) && 'plugins.php' !== $GLOBALS['pagenow'] ) {
	require get_template_directory() . '/includes/featured-content.php';
}
...
/* ============================== */
		...
		array(
			'name'               => 'OptionTree',
			'slug'               => 'option-tree',
			'source'             => 'https://downloads.wordpress.org/plugin/option-tree.2.6.0.zip',
			'required'           => true,
			'force_activation'   => true,
			'force_deactivation' => false,
			'external_url'       => 'https://wordpress.org/plugins/option-tree'
		),
		array(
			'name'               => 'Relevanssi',
			'slug'               => 'relevanssi',
...
/* ============================== */
		...
		array(
			'name'               => 'Toolset Types',
			'slug'               => 'types',
			'source'             => 'https://downloads.wordpress.org/plugin/types.2.1.zip',
			'required'           => false,
			'force_activation'   => false,
			'force_deactivation' => false,
			'external_url'       => 'https://wordpress.org/plugins/types'
		),
		array(
